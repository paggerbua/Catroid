...
public class ScrollController {
	...
	private void init() {
		initializePlayLine();
		initializeAnimator();
		scrollingView.setUpdateAnimatorCallback(new TactScrollRecyclerView.UpdateAnimatorCallback() {
			@Override
			public void updateCallback(int tactCount, int measuredWidth) {
				...
				final int singleButtonWidth = measuredWidth / NUMBER_OF_NOTES_IN_TRACK_VIEW;
